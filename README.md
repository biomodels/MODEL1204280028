# MODEL1204280028: MODEL1204280028
...
`pip install git+https://github.com/biomodels/MODEL1204280028.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1204280028.git@20140916`

## Usage

Importing the model package.

`import MODEL1204280028 as model`
...
(M4_K2_USEQ_short_duration_signal)
...
This model [ [MODEL1204280028](http://www.ebi.ac.uk/biomodels/MODEL1204280028)
\- M4_K2_USEQ_short_duration_signal] correspond to type M4 with mass action
kinetics K2, in short_duration_signal and USEQ (Unsequestrated ) condition.
This model can accessed from the non-curated branch of [BioModels
Database](http://www.ebi.ac.uk/biomodels) .
...
and identified by:
[MODEL1204280028](http://www.ebi.ac.uk/biomodels/MODEL1204280028) .
